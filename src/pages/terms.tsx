import { Container, TermsContainer } from '../../styles/pages/Terms';
      ...
      <TermsContainer>
        ...
        <ul>
          ...
          <p>
            ...
            encerrada, com base nos artigos 18 e 20 caput e parágrafo único da
            Lei 12.965/2014 e nos termos desta.
          </p>
          <p>
          ...
          <p>
            Consentimento do usuário (nos termos dos artigos 7°, I, V; 8° da Lei
            Geral de Proteção de Dados - Lei 13.709/2018): O simples cadastro de
            anunciante não gera custo. O anunciante poderá publicar 1 anúncio
            gratuitamente.
          </p>
          <p>
          ...
          <p>
            O pagamento das anuidades são feitos através de depósito bancário no
            banco Itaú. O depósito dever ser feito após a realização do cadastro
            de anunciante, com o valor correspondente do respectivo plano de
          ...
          <p>
            ...
            operadores. Ao acessar e usar esses sites o usuário concorda que o
            estará fazendo sob sua própria responsabilidade.
          </p>
          <p>
            A política de privacidade do imoveisdeluxo.com.br é aplicável
            somente quando o usuário está utilizando o imoveisdeluxo.com.br; uma
            vez linkado a outro website, o usuário estará sujeito à política de
            privacidade desse outro website, sobre a qual o imoveisdeluxo.com.br
            não tem qualquer relação.
          </p>
          A imoveisdeluxo.com.br se utiliza de tratamento de dados, conforme
          preceitua a Lei geral de Proteção de Dados – LGPD (Lei 13.709/2018) em
          seu art.5°, X; respeitando, dentre outros, o fundamento da privacidade
          exposto no artigo 2° da LGPD; realizando transferência dos dados
          fornecidos pelo usuário cadastrado com outras empresas parceiras, com
          o que o usuário concorda ao assinar nossos termos de uso.
          ...
          <p>
            ...
            prévia ao usuário, no caso de cometimento de ilegalidades ou crimes,
            na forma do parágrafo único do artigo 20 da lei do Marco Civil da
          ...
          <p>
            Este site se subordina às leis vigentes no Brasil, seus princípios e
            fundamentos, em especial, à Lei do Marco Civil da Internet (Lei
            12.965/2014) e Lei geral de Proteção de Dados (Lei 13.709/2018).
            Estando passível de eventuais alterações para se conformar à
            legislação em vigor. Qualquer divergência relacionada ao presente
            termo de uso deverá ser submetida às leis do Brasil.
          </p>
        </ul>
      </TermsContainer>
    </Container>
